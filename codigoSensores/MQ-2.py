...
MQTT_PASSWORD = ""
MQTT_CLIENT_ID = "" 
MQTT_SENSOR_TOPIC = "utng/gas"
MQTT_PORT = 1883

# Configuración del sensor de gas MQ-2 (conectado a un pin analógico, por ejemplo, ADC0 - GPIO 35)
...
# Ciclo de lectura del sensor de gas MQ-2
while True:
    valor_sensor = sensor_gas.read()  # Lectura del valor analógico (0-1023)
    print(f"Valor del sensor de gas: {valor_sensor}")
