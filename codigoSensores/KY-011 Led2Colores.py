...
led_azul_pin = Pin(12, Pin.OUT)  # GPIO12 para el LED azul
...
MQTT_PORT = 1883
MQTT_TOPIC_ACTUATOR = "sensor/led-2-colores"  # Tema para publicar estado del LED
...
while True:
    try:
        ...
        # Alternar LEDs
        for color, led_on, led_off in [("Rojo", led_rojo_pin, led_azul_pin), 
                                       ("Azul", led_azul_pin, led_rojo_pin)]:
            led_on.value(1)   # Encender LED correspondiente
            led_off.value(0)  # Apagar el otro LED
            mensaje = color   # Mensaje para MQTT
        ...
        # Si hay demasiados errores de conexión, reiniciar conexiones
    ...
    time.sleep(1)  # Esperar 1 segundos antes de la siguiente iteración
