...
MQTT_PASSWORD = ""
MQTT_CLIENT_ID = "" 
MQTT_SENSOR_TOPIC = "utng/mq9"
MQTT_PORT = 1883

# Configuración del sensor de gas MQ-9 (conectado a GPIO35)
...
# Ciclo de lectura del sensor de gas MQ-9
while True:
    valor_sensor = sensor_gas.read()  # Lectura del valor analógico (0-1023)
    print(f"Valor del sensor de gas MQ-9: {valor_sensor}")
